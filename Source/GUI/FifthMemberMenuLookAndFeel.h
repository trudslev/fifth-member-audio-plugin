...
*/
class FifthMemberMenuLookAndFeel final : public nf::MenuMetricsLookAndFeel
{
public:
...
public:
                                     ...
                                     const juce::String& sectionName) override
    {
        ...
        FifthMemberTheme::Text::drawTracked (g, sectionName,
...
private:
    ...
    static nf::MenuMetrics metrics()
    {
        ...
        m.sectionHeaderHeight = nf::captionHeight (FifthMemberTheme::Font::mono (headerTextSize), 3, 4);
        m.separatorHeight = 9;
