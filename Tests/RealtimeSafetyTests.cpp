...
/**
    Category 1 of the suite-wide bug sweep, for Fifth Member.

    **Core owns the drivers; this file owns what Fifth Member's answers should be.** That split is why
    ...
    `PluginProcessor.cpp:95` — `dryBuffer.setSize (numChannels, numSamples, false, false, true)`.
