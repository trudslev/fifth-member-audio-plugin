...
public:
    ...
    void runTest() override
    {
        ...
        beginTest ("RANKING — is the first-run difference a FADE-IN, or a hair of drift?");
        {
            ...
            //
            // SITE: DelayCore: delay time 60 ms, feedback 20 ms
            //
            ...
            FifthMemberAudioProcessor warmRef;
            warm (warmRef);
            ...
            FifthMemberAudioProcessor warmB;
            warm (warmB);
...
private:
    ...
    static void warm (FifthMemberAudioProcessor& p)
    {
        nf::testing::RenderSpec spec;
        spec.blockSize = 512;
        spec.numBlocks = 4;
