...
```sh
./build/Tests/FifthMemberTests_artefacts/Release/FifthMemberTests          # macOS / Linux
build\Tests\FifthMemberTests_artefacts\Release\FifthMemberTests.exe        # Windows
```
...
```sh
auval -v aufx Fm88 Nfdy

/Applications/pluginval.app/Contents/MacOS/pluginval \
    --strictness-level 8 \
    --validate ~/Library/Audio/Plug-Ins/VST3/Fifth Member.vst3
```

Windows:

```bat
pluginval.exe --strictness-level 8 --validate "%COMMONPROGRAMFILES%\VST3\Fifth Member.vst3"
```

Linux:

```sh
./pluginval --strictness-level 8 --validate ~/.vst3/Fifth Member.vst3
```
...
and can take many minutes — validate by code (`auval -v aufx Fm88 Nfdy`) instead.
