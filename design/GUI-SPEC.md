...
**User-name cap: 26 characters.** HELD at its existing value. 26 is section 6.2's measured cell budget; the marker would imply 24, but a cap must never contract - the existing 16px font step-down absorbs the overflow inside its 31-character budget.
